...
{
    hair_make_cpt('Ambassadors', 'Ambassador', 'ambassador', 'ambassadors', 6, 'dashicons-admin-users');
}
...
{
    hair_make_tax('Styles', 'Product Style', 'product_style', 'product-styles', array('product'));
}
